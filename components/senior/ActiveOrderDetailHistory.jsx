...
class ActiveOrderDetailHistory extends Component {

    constructor(props) {
        super(props);
        props.senior.query.type = ActiveOrderDetailHistory.orderType;
        this.state = {
        ...
        return (
            <div id="portal">
                ...
                <div className="content list wrap">
                    ...
                    <div className="listBack"><Link to={`${config.webContext}senior/admin/order/${oldOrderHistory.id}/active`}>回申請單明細</Link></div>
...
export default connect(state => ({historys: state.senior.historys}), {...OrderActions})(ActiveOrderDetailHistory)